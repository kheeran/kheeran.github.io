...
publication: https://www.dagstuhl.de/dagpub/approx_random21/getFile.php?session_id=8n31n6j8h7q0ciu9jo76qgl8i3&hash=910618c72d17d6a59275a91a54f21855c0a96864292e1669fab12991740038f4
video: https://www.youtube.com/watch?v=0OwsPy4B3Rc
---

This is my very first publication. I am grateful to my parents for always supporting and believing in me. I am thankful to my friends who have always been a great source of inspiration and challenge. And last but not least, I could not have done this without the excellent guidance and mentorship from my supervisor and co-author Christian. 
...
View the published paper [here]({{ page.publication }}){:target="_blank"}.

View the ArXiv version [here]({{ page.arxiv }}){:target="_blank"}

View the conference talk [here]({{ page.video }}){:target="_blank"}.